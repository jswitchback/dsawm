...
<?php if (theme_get_setting('d7theme_conditional_classes_html')): ?>
  ...
  <!--[if (IE 7)&(!IEMobile)]><html class="ie lt-ie9 lt-ie8 no-js" lang="<?php print $language->language; ?>" dir="<?php print $language->dir; ?>"><![endif]-->
  <!--[if IE 8]><html class="ie lt-ie9 no-js" lang="<?php print $language->language; ?>" dir="<?php print $language->dir; ?>"><![endif]-->
  <!--[if (gte IE 9)|(gt IEMobile 7)]><html class="ie no-js" lang="<?php print $language->language; ?>" dir="<?php print $language->dir; ?>"<?php print $rdf_namespaces; ?>><![endif]-->
...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php print $base_path . $path_to_d7theme; ?>/images/app-icons/apple-touch-icon-144x144-precomposed.png">
  <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php print $base_path . $path_to_d7theme; ?>/images/app-icons/apple-touch-icon-114x114-precomposed.png">
  <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php print $base_path . $path_to_d7theme; ?>/images/app-icons/apple-touch-icon-72x72-precomposed.png">
  <link rel="apple-touch-icon-precomposed" href="<?php print $base_path . $path_to_d7theme; ?>/images/app-icons/apple-touch-icon-precomposed.png">
